...
This will trigger a redeployment of the oAuth Operator. You can monitor the rollout with the following command.
...
pre-configured. When it comes to *Projects*, you similarly can grant view, edit,
